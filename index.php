            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <p class="text-muted"><span class="typewrite d-inline" data-period="2000" data-type='[ " Desarrollador Web. ", "Tecnico superior en Desarrollo de Software. ", "FullStack " ]'></span></p>
                        <h2>Hola, Soy <span>Diego</span></h2>
                        <h3 class="mb-20"> Bienvenidos a mi web</h3>
                        <h5 class="text-muted">Esta pagina fue hecha por un curso</h5>
                    </div>
